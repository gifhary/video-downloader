...
import 'package:video_downloader/module/twitter_downloader/data/network/twitter_downloader_network.dart';

class TwitterDownloaderRepo {
  final _myNetwork = TwitterDownloaderNetwork();
